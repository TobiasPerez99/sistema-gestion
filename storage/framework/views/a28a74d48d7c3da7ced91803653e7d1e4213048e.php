                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-check custom-checkbox mt-4">
                                        ...
                                        <label class="form-check-label " for="discount_apply"><?php echo e(__('Discount Apply')); ?></label>
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Repositorios\erp\resources\views/proposal/create.blade.php ENDPATH**/ ?>